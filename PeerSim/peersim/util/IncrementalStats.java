...
public class IncrementalStats implements Serializable {
	...
	/**
	 * Resets the statistics to reflect the zero elements set. Min and max are
	 * set to positive and negative infinity, respectively.
	 */
	public void reset() {
	 ...
	 * equal to 0.0. If due to rounding errors the value becomes negative, it
	 * returns 0.0.
	 */
	...
	/**
	 * Prints the following quantities separated by spaces in a single line in
	 * this order. Minimum, maximum, number of items, average, variance, number
	 * of minimal items, number of maximal items.
	 */
