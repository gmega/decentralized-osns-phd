 ...
 * @since   JDK1.0
 */
public class FastGetBitset implements Cloneable, java.io.Serializable {
    /*
     ...
     *         is negative
     */
    public FastGetBitset(int nbits) {
     ...
     */
    private FastGetBitset(long[] words) {
        this.words = words;
     ...
     * @since  1.4
     */
    public FastGetBitset get(int fromIndex, int toIndex) {
        checkRange(fromIndex, toIndex);
        ...
        if (len <= fromIndex || fromIndex == toIndex)
            return new FastGetBitset(0);

        // An optimization
        if (toIndex > len)
            toIndex = len;

        FastGetBitset result = new FastGetBitset(toIndex - fromIndex);
     ...
     * @since  1.4
     */
    public boolean intersects(FastGetBitset set) {
     ...
     * @param set a bit set
     */
    public void and(FastGetBitset set) {
        if (this == set)
            return;
     ...
     * @param set a bit set
     */
    public void or(FastGetBitset set) {
        if (this == set)
            return;
     ...
     * @param  set a bit set
     */
    public void xor(FastGetBitset set) {
        int wordsInCommon = Math.min(wordsInUse, set.wordsInUse);
     ...
     * @since  1.2
     */
    public void andNot(FastGetBitset set) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof FastGetBitset))
            return false;
        if (this == obj)
            return true;

        FastGetBitset set = (FastGetBitset) obj;
    ...
    public Object clone() {
        ...
        try {
            FastGetBitset result = (FastGetBitset) super.clone();
