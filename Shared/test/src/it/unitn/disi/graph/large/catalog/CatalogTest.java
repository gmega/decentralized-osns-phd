...
public class CatalogTest {
	...
	private static  IndexedNeighborGraph fOriginal;

	private static byte[] fIndex;

	private static byte[] fRewritten;

	@BeforeClass
	public static void setUp() throws Exception {
		File file = new File(CatalogTest.class.getClassLoader()
